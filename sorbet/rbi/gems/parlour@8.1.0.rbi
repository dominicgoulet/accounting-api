...
class Parlour::RbiGenerator::Namespace < ::Parlour::RbiGenerator::RbiObject
  ...
  # @return [Attribute]
  #
  # source://sorbet-runtime/0.5.10754/lib/types/private/methods/_methods.rb#255
...
class Parlour::TypeParser::IntermediateSig < ::T::Struct
  ...
  class << self
    # source://sorbet-runtime/0.5.10754/lib/types/struct.rb#13
    def inherited(s); end
  end
end
...
class Parlour::Types::Type
  ...
  # source://sorbet-runtime/0.5.10754/lib/types/private/abstract/declare.rb#37
