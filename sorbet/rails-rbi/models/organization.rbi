...
module Organization::QueryMethodsReturningRelation
  ...
  sig { params(args: Symbol).returns(Organization::ActiveRecord_Relation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Organization::ActiveRecord_Relation) }
...
module Organization::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: Symbol).returns(Organization::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end

  sig { params(column: Symbol, values: T::Array[T.untyped]).returns(Organization::ActiveRecord_AssociationRelation) }
  def in_order_of(column, values); end
