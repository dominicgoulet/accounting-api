...
module GeneratedUrlHelpers
  ...
  # Sigs for route /registrations(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  ...
  # Sigs for route /registrations/confirm(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def registrations_confirm_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def registrations_confirm_url(*args, **kwargs); end

  # Sigs for route /registrations/accept-invitation(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def registrations_accept_invitation_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def registrations_accept_invitation_url(*args, **kwargs); end

  # Sigs for route /registrations/cancel-email-change(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def registrations_cancel_email_change_path(*args, **kwargs); end
